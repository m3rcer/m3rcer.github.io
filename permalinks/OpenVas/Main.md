---
title: Main Class
permalink: /permalinks/OpenVas/Main
categories: greyhatcch7
---

## The Main Method shows how to implement OpenVASSession and Manager classes to run a scan and generate results of the scan on console.


* We disable SSL certificate verification. Once we have an authenticated session and a manager, we can begin interacting with the Nessus server.
