...
# Modern SMTP Builds and Operations for Phishing
...
Refer this [section here](StartingPoint) to gain a brief understanding of MTA filter bypasses before you delve into any listed method.
...
**`NOTE:` All numbering below is in accordance to each specified methods listed here**
...
- [Alexander Færøy](https://gitlab.torproject.org/ahf)
